        ...
        <div className="album py-5 bg-light">
          <div className="container">
            ...
            <div className="text-end" style={{position: 'sticky', bottom: 0}}>
              ...
              <span className="d-inline-block p-2 m-2 card shadow-sm" style={{ borderRadius: '15%', fontSize: '.8rem' }} onClick={ () => window.scrollTo(0,graphsEl.current.getBoundingClientRect().y + window.scrollY) }>
